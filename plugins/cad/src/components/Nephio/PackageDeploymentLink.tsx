...
type PackageDeploymentLinkProps = {
  deploymentName: string;
  breadcrumb?: boolean;
};

export const PackageDeploymentLink = ({
  deploymentName,
  breadcrumb,
}: PackageDeploymentLinkProps) => {
  ...
  return (
    <Link className={className} to={packageDeploymentRef({ deploymentName })}>
      {deploymentName}
    </Link>
  );
};
